/* a very simmilar idea to the program I'm trying to write, 
except that this progarm is execution an enter /n after every new sentence, 
which is a function I don't want and couldn't fix (I tried)*/
